...
public class CardsAdapter extends RecyclerView.Adapter<CardsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        setFormattedText(holder.textViewCardTotal, R.string.label_balance, card.getTotalFormatted());
        ...
        setFormattedText(holder.textViewCardLastCharge, R.string.label_last_charge, card.getLastChargeFormatted());
        setFormattedText(holder.textViewCardLastUpdate, R.string.label_last_update, card.getLastUpdateFormatted());
